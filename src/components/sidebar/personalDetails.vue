  ...
  <div class="personalDetails" id="introduction">
     <!-- 个人简介 -->
             <div class="block">
              <h2>王文硕·简介</h2>
              <div>
                <p><i class="iconfont My-new-iconzhiye"></i>职业：大二学生、前端学习者</p>
                <p><i class="iconfont My-new-icondingwei1"></i>现居：天津市</p>
                <p><i class="iconfont My-new-iconyouxiang"></i>Email:wws__qln@163.com</p>
              </div>
              <div>
                <ul class="buttonBox">
                  <li class="item">
                   ...
                   <li class="item">
                    <a href="javascript:;" title="个人邮箱：wws__qln@163.com" class="item-e-mail"></a>
                  </li>
                  <li class="item">
                    <a href="https://gitee.com/wangwenshuoyyds" title="gitee主页" target="_blank" class="item-git"></a>
                  </li>
                  <li class="item">
