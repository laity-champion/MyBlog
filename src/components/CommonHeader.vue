...
<div>
  ...
  <header>
      <div class="wrapper">
        <el-row>
          <el-col :span="4">
            <div class="logo threed">王先森个人博客站</div>
          </el-col>
          <!-- 响应式设计 -->
          <el-col :span="20">
            <!-- 导航菜单 -->
            ...
            >
              ...
              <el-menu-item index="8"  @click="goToto">
                 <router-link to="/article" v-if="isSignIn === 1 && nickname === '王先森'">我的博客</router-link>
              </el-menu-item>
              <el-menu-item index="9" @click="goToto">
               ...
               <el-menu-item index="10"  @click="goToto">
                 <router-link to="/personal"  v-if="isSignIn === 1 "  class="login">{{UserInfo.nickname === '王先森' ? '管理员：' + UserInfo.nickname : '游客：'+ UserInfo.nickname}}</router-link>
              </el-menu-item>
            </el-menu>
          </el-col>
          <!-- 搜索功能 -->
      ...
      <el-menu
          ...
          <el-submenu index="1">
            <template slot="title">
              ...
              <span class="logotit">王先森个人博客站</span>
